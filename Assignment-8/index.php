...
if(isset($_POST['submit'])){
  ...
  if(empty($name) || empty($username) || empty($email) || empty($password)){
    ...
    $errorMessage=' <li class="list-group-item list-group-item-danger">Username already exists</li>';
    ...
    $password=md5($_POST['password']);
    $errorMessage=' <li class="list-group-item list-group-item-danger">Password must be greater than 8 characters</li>';
  }else {
